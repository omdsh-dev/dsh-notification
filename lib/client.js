...
function shouldShow(permission, backgroundOnly, documentHidden) {
...
var zh = {
  ...
  "settings.advanced.backgroundOnly": "\u4EC5\u5728\u540E\u53F0\u65F6\u901A\u77E5",
  "settings.advanced.backgroundOnlyDesc": "\u53EA\u6709\u5F53\u524D\u9875\u9762\u4E0D\u5728\u524D\u53F0\u65F6\u624D\u5F39\u51FA\u901A\u77E5\uFF0C\u907F\u514D\u6B63\u5728\u89C2\u770B\u65F6\u88AB\u6253\u6270\u3002",
...
var en = {
  ...
  "settings.advanced.backgroundOnly": "Only notify in the background",
  "settings.advanced.backgroundOnlyDesc": "Only notify while this page is not focused, so you are not interrupted while watching.",
  ...
  ctx.effect(() => {
    ...
    const off = sessions.list.subscribe(() => {
      ...
      for (const id of state.ids) {
        ...
        console.info(
          `[dsh-notification] turn ${nextTurn} ${id}: reason=${plan.reason} show=${showIt} (permission=${permission} backgroundOnly=${current.backgroundOnly} hidden=${document.hidden})`
        );
        if (showIt) {
          show(
